...
<body class="body">
    ...
    <div id="white-container" class="container-fluid">
        <#assign mobile_template = true>
        <#assign desktop_template = false>
        <#assign template_type = "mobile">

        <#include "templates/banners/nota/mobile/NM-HS1.ftl">
        <#include "templates/common/header-mobile.ftl">
