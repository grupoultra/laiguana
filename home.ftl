...
-->
    ...
    <body class="body">
        ...
        <![endif]-->
            ...
            <div class="row hidden-sm hidden-xs">
                ...
                <div class="row  mobile-header hidden-md hidden-lg">
                    ...
                    <div>
                        <img src="/activos/images/li_mobile_head.png" style="width: 50%; height: auto;">
                    </div>
                    <div>
                ...
                <div class="row social-box hidden-md hidden-lg center-block">
                    ...
                    <div class="fb-like" data-href="https://www.facebook.com/iguana.tv" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false">
                    </div>
                    -->
                    ...
                    <div class="">
                        <ul class="social-nav model-9">
                            ...
                            <li><a class="twitter" target="_blank" title="Twitter" href="http://www.twitter.com/la_iguanatv"><i class="fa fa-twitter"></i></a></li>
                            <li><a class="youtube" target="_blank" title="Youtube" href="http://www.youtube.com/channel/UCCc2H9_eNnU7ucq2n7Sh3Rg"><i class="fa fa-youtube-play"></i></a></li>
                            <li><a class="pinterest" target="_blank" title="Pinterest" href="http://www.pinterest.com/laiguanatv"><i class="fa fa-pinterest-p"></i></a></li>
                            <li><a class="instagram" target="_blank" title="Instagram" href="http://instagram.com/laiguanatv"><i class="fa fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row  hidden-sm hidden-xs" style="background-image: url(/activos/images/logo.png); height: 155px; width: 970px;">
                ...
                <#--ul.row.menu-principal.hidden-sm.hidden-xs>li.col-md-2.menu-item.item-.clean{hola}*6>a-->
                <ul class="row menu-principal hidden-sm hidden-xs">
                    <li class="col-md-2 menu-item clean"><a href="#"></a></li>
                    <li class="col-md-2 menu-item clean"><a href="#"></a></li>
                    <li class="col-md-2 menu-item clean"><a href="#"></a></li>
                    <li class="col-md-2 menu-item clean"><a href="#"></a></li>
                    <li class="col-md-2 menu-item clean"><a href="#"></a></li>
                ...
                <!-- **************************************
                 ...
                 | (___ | |_  __| | ___  | (___ | |__   _____      __
                  \___ \| | |/ _` |/ _ \  \___ \| '_ \ / _ \ \ /\ / /
                  ____) | | | (_| |  __/  ____) | | | | (_) \ V  V /
                 |_____/|_|_|\__,_|\___| |_____/|_| |_|\___/ \_/\_/
            ...
            <div class="row content-row">
                ...
                <div class="col-p clean padding-left hidden-sm hidden-xs  ">
                    <div >
            ...
            <div class="row  content-row">
                ...
                <div class="col-g vstretch">
                    ...
                    <div class="col-g content-row left-padded-half hidden-sm hidden-xs" style="align:center;">
                        <ins data-revive-zoneid="16" data-revive-id="38ec9e535834d2deaccb0c4ab130d46e"></ins>
                    </div>
            ...
            <!-- **************************************
              _____
             |_   _|
               | |  __ _ _   _  __ _ _ __   __ _ _______  ___
               | | / _` | | | |/ _` | '_ \ / _` |_  / _ \/ __|
              _| || (_| | |_| | (_| | | | | (_| |/ / (_) \__ \
             |_____\__, |\__,_|\__,_|_| |_|\__,_/___\___/|___/
                    __/ |
                   |___/
             ******************************************* -->
            ...
            <!-- ************************************** -->
                ...
                <div class="row image-row  hidden-sm hidden-xs">
                    <div class="col-md-12 clean ">
            ...
            ************************************** -->
            ...
            <div class="row content-row h-normal">
                ...
                <div class="col-md-4 h-normal hidden-sm hidden-xs">
                    <div class="ucard h-normal stretch round-right clean">
                        ...
                        <h3 class="titulo">
                            <a class="nolink" href="${notas.getNota("lomasjot",2).getPath()}">
                            <img class="" src="${notas.getNota("lomasjot",2).getHeroImage()}" alt="Card image cap" style="width:260px; height: 80px;">
                            ${notas.getNota("lomasjot",2).getTitulo(75)}
                            </a>
                        </h3>

                        <h3 class="titulo">
                            <a class="nolink" href="${notas.getNota("lomasjot",3).getPath()}">
                            <img class="" src="${notas.getNota("lomasjot",3).getHeroImage()}" alt="Card image cap" style="width:260px; height: 80px;">
                            ${notas.getNota("lomasjot",3).getTitulo(75)}
                            </a>
                        </h3>

                        <h3 class="titulo">
                            <a class="nolink" href="${notas.getNota("lomasjot",4).getPath()}">
                            <img class="" src="${notas.getNota("lomasjot",4).getHeroImage()}" alt="Card image cap" style="width:260px; height: 80px;">
                            ${notas.getNota("lomasjot",4).getTitulo(75)}
                            </a>
                        </h3>
            ...
            <div class="row content-row">
                ...
                <div class="col-p   col-doble  hidden-sm hidden-xs">
                    ...
                    <div class="ucard h-normal h-doble round-left orange-border vstretch">
        ...
        <div id="footer" class="footer-text">
            <div class="sp-wrap">
                <div class="cp">
                    Copyright © La Iguana TV 2016. Todos los derechos reservados.
                </div>
                <a id="topofpage" href="#" rel="nofollow">Ir Arriba</a>
                <div class="mercadeo" style="clear:both">
                    <span id="cloak4571"><a href="mailto:mercadeolaiguanatv@gmail.com">mercadeolaiguanatv@gmail.com</a></span>
