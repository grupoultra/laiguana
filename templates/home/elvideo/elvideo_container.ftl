...
<div style="position:relative; padding-bottom:62.5%; overflow:hidden;"><iframe src="//content.jwplatform.com/players/P65uzM6b-gxQq543p.html" width="100%" height="100%" frameborder="0" scrolling="auto" allowfullscreen style="position:absolute;"></iframe></div>
