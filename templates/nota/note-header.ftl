    ...
    <div class="articulo-barra">
        <div class="row">
            ...
            <div class="col-xs-6 col-md-2">
                ...
                <img src="/activos/images/fb-share-tag.png" alt="La Iguana Facebook" onclick="return share('FB', '${nota.getPath()}')">
            </div>
            <div class="col-xs-6 col-md-2">
                <a class="twitter-shar-button" href="https://twitter.com/intent/tweet?text=${nota.getTitulo()?replace("'","")?replace("%"," por ciento")?replace("#","")?replace("$","USD")?replace("&","y")} http://laiguana.tv${nota.getPath()} @la_iguanatv">
                    <img src="/activos/images/tw-share-tag.png" alt="La Iguana Twitter" />
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
                <img src="/activos/images/gp-share-tag.png" alt="La Iguana Google Plus"  onclick="return share('GP', '${nota.getPath()}')">
            </div>
            <div class="col-xs-6 col-md-2">
                    <a href="mailto:?&subject=Compartido a través de LaIguana.tv&body=http://laiguana.tv${nota.getPath()}">
                        <img src="/activos/images/mail-share-tag.png"  alt="La Iguana Mail" >
                    </a>
            </div>
        </div>
    </div>
